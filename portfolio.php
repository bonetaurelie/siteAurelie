...
<div class="container">
    <div class="row">
        ...
        <ul>
            ...
            <li class="projet"><a itemprop="url" href="#" target="_blank">Gestionnaire de livres Symfony2/Bootstrap</a></li>
            <li class="projet"><a itemprop="url" href="#" target="_blank">Mon site personnel PHP/Bootstrap/JQuery</a></li>
